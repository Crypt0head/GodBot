...
const std::map<ORDER_RESEPONSE_TYPE, std::string> base_api::order_response_type_ = std::map<ORDER_RESEPONSE_TYPE, std::string>({
	{ORDER_RESEPONSE_TYPE::ACK, "ACK"},{ORDER_RESEPONSE_TYPE::RESULT, "RESULT"},{ORDER_RESEPONSE_TYPE::FULL, "FULL"}});

const std::map<ORDER_SIDE_EFFECT_TYPE, std::string> base_api::order_side_effect_type_ = std::map<ORDER_SIDE_EFFECT_TYPE, std::string>({
	{ORDER_SIDE_EFFECT_TYPE::NO_SIDE_EFFECT, "NO_SIDE_EFFECT"},{ORDER_SIDE_EFFECT_TYPE::MARGIN_BUY, "MARGIN_BUY"},{ORDER_SIDE_EFFECT_TYPE::AUTO_REPAY, "AUTO_REPAY"},{ORDER_SIDE_EFFECT_TYPE::AUTO_BORROW_REPAY, "AUTO_BORROW_REPAY"}});